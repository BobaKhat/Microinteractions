import svgPaths from "./svg-qftxbku222";
...
function Frame3() {
  return (
    <div className="bg-[#2c2c2e] content-stretch flex gap-[15px] items-center justify-center p-[10px] relative rounded-[5px] shrink-0">
      <Group />
...
function Frame1() {
  return (
    <div className="-translate-x-1/2 absolute bg-[#1e1b1b] content-stretch flex gap-[25px] items-center left-[calc(50%-0.14px)] overflow-clip px-[20px] py-[15px] rounded-[5px] top-[157px]">
      <Frame3 />
      <Frame2 />
      <Frame4 />
    </div>
